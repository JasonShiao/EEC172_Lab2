...
*/
    ...
    GPIOPinWrite(GPIOA2_BASE, PIN_DC, 0); // set data pin low - only sending command
    GPIOPinWrite(GPIOA3_BASE, PIN_OC, 0); // chip select low
    ...
    GPIOPinWrite(GPIOA3_BASE, PIN_OC, PIN_OC); // pull chip select high
...
*/
    ...
    GPIOPinWrite(GPIOA2_BASE, PIN_DC, PIN_DC); //Set Data command pin High
    GPIOPinWrite(GPIOA3_BASE, PIN_OC, 0); // Set Chip-Select Pin Low

    MAP_SPIDataPut(GSPI_BASE, c); // Put data to slave

    //Message("\n\r\r Visit writeData func \n\r");
    MAP_SPIDataGet(GSPI_BASE,&ulDummy); // Receive Response from Slave
    GPIOPinWrite(GPIOA3_BASE, PIN_OC, PIN_OC); // Set Chip-Select Pin High
